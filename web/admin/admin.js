...
(() => {
  ...
  const DICT = {
    uz: {
      ...
      "dash.devices.expose":    "Port ochish",
      "dash.expose.title":      "Qurilmada portni ochish",
      "dash.expose.intro":      "Bu qurilma siz tanlagan portni mesh peer'lariga ochib beradi. Target bo'sh — mahalliy xizmat (localhost). Target to'liq — boshqa qurilma yoki tashqi domen.",
      "dash.expose.name":       "Nom",
      "dash.expose.name.ph":    "masalan: nvr, minecraft, web",
      "dash.expose.proto":      "Protokol",
      "dash.expose.port":       "Mesh port",
      "dash.expose.port.ph":    "8554",
      "dash.expose.target":     "Target (host:port)",
      "dash.expose.target.ph":  "bo'sh = localhost · 192.168.1.50:554 · example.com:443",
      "dash.expose.submit":     "Ochish",
      "dash.expose.cancel":     "Bekor",
      "dash.expose.success":    "Port muvaffaqiyatli ochildi",
      "dash.expose.err.device_offline": "Qurilma ulanmagan",
      "dash.expose.err.ack_timeout":    "Qurilma javob bermadi (8s)",
      "dash.expose.err.no_handler":     "Qurilmada bu xususiyat yo'q (eski versiya)",
    ...
    en: {
      ...
      "dash.devices.expose":    "Expose port",
      "dash.expose.title":      "Expose a port on this device",
      "dash.expose.intro":      "The device will open the chosen port to peers in its mesh. Leave Target empty for a local service (localhost). Set Target to a LAN IP or remote host to tunnel that endpoint through the device.",
      "dash.expose.name":       "Name",
      "dash.expose.name.ph":    "e.g. nvr, minecraft, web",
      "dash.expose.proto":      "Protocol",
      "dash.expose.port":       "Mesh port",
      "dash.expose.port.ph":    "8554",
      "dash.expose.target":     "Target (host:port)",
      "dash.expose.target.ph":  "empty = localhost · 192.168.1.50:554 · example.com:443",
      "dash.expose.submit":     "Expose",
      "dash.expose.cancel":     "Cancel",
      "dash.expose.success":    "Service exposed successfully",
      "dash.expose.err.device_offline": "Device is offline",
      "dash.expose.err.ack_timeout":    "Device did not respond (8s)",
      "dash.expose.err.no_handler":     "Device lacks this feature (older version)",
